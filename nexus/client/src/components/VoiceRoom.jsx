  ...
  useEffect(() => {
    navigator.mediaDevices.getUserMedia({
      audio: {
        ...
        voiceIsolation:      true,    // Chrome 116+ — AI tabanlı ses izolasyonu, sadece konuşmayı alır
        // Chrome / Edge genişletilmiş kısıtlamaları
        googEchoCancellation:         true,
        googNoiseSuppression:         true,
        googHighpassFilter:           true,  // düşük frekanslı ortam sesini (klima, fan) keser
        googNoiseSuppression2:        true,  // genişletilmiş gürültü bastırma
        googEchoCancellation2:        true,
        googDAEchoCancellation:       true,  // ek echo cancellation katmanı
        googAutoGainControl:          false,
        googAutoGainControl2:         false,
        googTypingNoiseDetection:     true,
        googBeamforming:              false, // çok mikrofonlu sistemlerde kapatmak daha iyi
